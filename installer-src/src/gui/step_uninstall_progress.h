...
class StepUninstallProgress : public Fl_Group {
public:
    StepUninstallProgress(int x, int y, int w, int h, MainWindow* parent_window, core::InstallerState& state);
    ~StepUninstallProgress();
